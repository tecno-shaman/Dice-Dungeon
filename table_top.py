...
class Entity:
    def __init__(self, name, image, container_values, attack, x, y):
        self.name = name
    ...
    def add_dice(self, dice):
        ...
        for i, value in enumerate(self.container):
            if self.container_slots[i] == -1 and value == dice.value and self.container_rects[i].collidepoint(dice.rect.center):
    ...
    def draw(self, surface):
        ...
        surface.blit(attack_text, (self.rect.right - 70, self.rect.y + 10))
...
enemies = [
    Enemy("Goblin", "ghost.png", [3, 4, 6], 5, 10, 10),
    Enemy("Orc", "ghost.png", [2, 5, 6], 8, 240, 10),
    Enemy("Dragon", "ghost.png", [5, 6, 6], 12, 470, 10),
]
